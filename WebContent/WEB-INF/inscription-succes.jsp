...
<body class="resto">
	...
	<div>
		...
		Félicitations <span class="italic" style="color: var(- -bs-red)"><%=request.getParameter("prenom")%>
			<%=request.getParameter("nom")%> </span><br /> Vous êtes bien inscrit(e)
		sur <span class="italic" style="color: var(- -bs-red)">Eat&Love</span>
		<br /> <br /> <a href="connexion.jsp">Connectez-vous à votre
			espace</a>
	</div>
	</main>
