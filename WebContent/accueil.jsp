	...
	<div class="carousel slide" data-bs-ride="carousel" id="conteneur">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block" src="WEB-SRC/img/salade-Caprese.jpg"
					alt="exemple d'entrée" />
				<div class="carousel-caption">
					<p>Des entrées préparées avec amour</p>
				</div>
			</div>
			<div class="carousel-item">
				<img class="d-block" src="WEB-SRC/img/pateitalienne.jpg"
					alt="exemple d'entrée" />
				<div class="carousel-caption">
			...
			<div class="carousel-item">
				<img class="d-block" src="WEB-SRC/img/tiramisu1.png"
					alt="exemple d'entrée" />
				<div class="carousel-caption">
			...
			<div class="carousel-item">
				<img class="d-block" src="WEB-SRC/img/limonade.jpg"
					alt="exemple d'entrée" />
				<div class="carousel-caption">
		...
		<a class="carousel-control-prev" type="button" data-bs-slide="prev"
			href="#conteneur"> <span class="carousel-control-prev-icon"></span>
		</a> <a class="carousel-control-next" type="button" data-bs-slide="next"
			href="#conteneur"> <span class="carousel-control-next-icon"></span>
		</a>
	</div>
	</section>
...
<div class="social_media">
	<img class="sm_img" src="WEB-SRC/img/banniere.PNG"
		alt="icônes réseaux sociaux">
</div>
